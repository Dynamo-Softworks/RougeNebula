...
public class playerController extends entityController{
	...
	//The 
	public void movePupet(ConsoleSystemInterface csi, TextInformBox messenger){
		...
		toolBox.sendMessage(messenger, puppet.getName()+" is at location X:"+puppet.getX()+" Y:"+puppet.getY());
		//messenger.draw();
		//messenger.clear();
	}
