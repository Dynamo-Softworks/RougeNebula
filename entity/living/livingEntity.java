...
public class livingEntity extends entity{
	...
	private ArrayList<itemEntity> bodyParts;
	
	
	private char type;
	
	//Really Basic Constructor
	public livingEntity(char c){
		type=c;
	}
	...
	*/
	...
	public void setInventory(ArrayList<itemEntity> inventory) {
		this.inventory = inventory;
	}

	public ArrayList<itemEntity> getBodyParts() {
		return bodyParts;
	}

	public void setBodyParts(ArrayList<itemEntity> bodyParts) {
